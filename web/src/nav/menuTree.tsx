...
export const MENU_TREE: MenuGroup[] = [
  ...
  { key: "g-plastic-pur", label: "塑胶采购", children: [
    M("塑胶采购分析", "/plastic-material-analysis", "塑胶物料单"), M("塑胶物料设置"), M("塑胶订单制作"), M("塑胶采购订单"),
  ...
  { key: "g-plastic-rpt", label: "塑胶报表", children: [
    ...
    M("原料本月库存汇总", "/plastic-raw-material-summary", "原料本月库存汇总"), M("塑胶分析明细查询", "/plastic-analysis-detail", "塑胶分析明细查询"), M("塑胶订购单查询", "/plastic-order-query", "塑胶订购单查询"), M("塑胶标签查询"),
