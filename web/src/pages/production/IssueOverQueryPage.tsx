...
import { productionReportApi, type IssueOverRow } from "../../api/productionReports";
...
export default function IssueOverQueryPage() {
  const perms = usePerms();
  const canOpen = can(perms, MENU, "打开");

  const [rows, setRows] = useState<IssueOverRow[]>([]);
