...
[ApiController]
[Authorize]
[Route("api/plastic-returns")]
public sealed class PlasticReturnController(
    PlasticReturnService svc, IPostingEngine posting, IPermissionService perms) : ControllerBase
{
    private const string Menu = "塑胶退料单";
    private const string Table = "塑胶退料单";
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] PlasticReturnCreateDto dto)
    {
