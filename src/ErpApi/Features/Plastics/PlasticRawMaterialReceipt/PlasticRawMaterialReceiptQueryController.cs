...
[ApiController]
[Authorize]
[Route("api/plastic-raw-material-receipt-query")]
public sealed class PlasticRawMaterialReceiptQueryController(
    PlasticRawMaterialReceiptService svc, IPermissionService perms) : ControllerBase
{
    private const string Menu = "原料入仓查询";
