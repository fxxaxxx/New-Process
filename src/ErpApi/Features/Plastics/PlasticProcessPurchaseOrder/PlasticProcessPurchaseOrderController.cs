...
[ApiController]
[Authorize]
[Route("api/plastic-process-purchase-orders")]
public sealed class PlasticProcessPurchaseOrderController(
    PlasticProcessPurchaseOrderService svc, IPostingEngine posting, IPermissionService perms) : ControllerBase
{
    private const string Menu = "塑胶加工采购单";
    private const string Table = "塑胶加工采购单";
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] PlasticProcessPurchaseOrderCreateDto dto)
    {
