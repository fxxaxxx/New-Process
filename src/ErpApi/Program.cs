...
builder.Services.AddScoped<ErpApi.Features.Warehouse.Semi.SemiStocktakeQueryService>();
builder.Services.AddScoped<ErpApi.Features.Warehouse.Finished.FinishedReceiptQueryService>();
